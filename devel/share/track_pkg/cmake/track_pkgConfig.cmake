...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'track_pkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/exbot/tracker_ws/src/track_pkg/${idir}'.  Ask the maintainer 'exbot <exbot@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/exbot/tracker_ws/devel/lib;/home/exbot/tracker_ws/devel/lib;/opt/ros/indigo/lib)
